...
function SheetOverlay({ className, ...props }) {
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // Increased opacity for a stronger overlay effect
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          // Ensure background and text colors are consistent with theme
          // bg-background is typically a light background, text-foreground is typically dark text
